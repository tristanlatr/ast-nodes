...
class type_ignore(ast.type_ignore, AST): ...
...
class Module(ast.Module, mod):
    ...
    def __init__(self, lineno: int=-1, col_offset: int=0, parent:Optional['AST']=None, *, end_lineno: Optional[int]=None, end_col_offset: Optional[int]=None) -> None:
        ...
        self.type_ignores = _unset_init

    def _postinit(self, body:'list[stmt]'=_unset, type_ignores:'list[TypeIgnore]'=_unset) -> None:
        """start checking validation"""
        if body is _unset: body = []
        if type_ignores is _unset: type_ignores = []
        self.body = body #type:ignore
        self.type_ignores = type_ignores #type:ignore
...
class FunctionType(ast.FunctionType, mod):

    def __init__(self, lineno: int=-1, col_offset: int=0, parent:Optional['AST']=None, *, end_lineno: Optional[int]=None, end_col_offset: Optional[int]=None) -> None:
        super().__init__(lineno, col_offset, parent, end_lineno=end_lineno, end_col_offset=end_col_offset)
        # all fields defaults to _unset_init
        self.argtypes = _unset_init
        self.returns = _unset_init

    def _postinit(self, argtypes:'list[expr]'=_unset, returns:'expr'=_unset) -> None:
        """start checking validation"""
        if argtypes is _unset: argtypes = []
        if returns is _unset: raise ValueError('returns cannot be empty.')
        self.argtypes = argtypes #type:ignore
...
class FunctionDef(ast.FunctionDef, stmt):
    ...
    def __init__(self, lineno: int=-1, col_offset: int=0, parent:Optional['AST']=None, *, end_lineno: Optional[int]=None, end_col_offset: Optional[int]=None) -> None:
        ...
        self.returns = _unset_init
        self.type_comment = _unset_init

    def _postinit(self, name:'str'=_unset, args:'arguments'=_unset, body:'list[stmt]'=_unset, decorator_list:'list[expr]'=_unset, returns:'expr | None'=_unset, type_comment:'Any'=_unset) -> None:
        """start checking validation"""
...
class Assign(ast.Assign, stmt):
    ...
    def _postinit(self, targets:'list[expr]'=_unset, value:'expr'=_unset, type_comment:'Any'=_unset) -> None:
        """start checking validation"""
        if targets is _unset: targets = []
...
class For(ast.For, stmt):
    ...
    def _postinit(self, target:'expr'=_unset, iter:'expr'=_unset, body:'list[stmt]'=_unset, orelse:'list[stmt]'=_unset, type_comment:'Any'=_unset) -> None:
        """start checking validation"""
        if target is _unset: raise ValueError('target cannot be empty.')
...
class With(ast.With, stmt):
    ...
    def _postinit(self, items:'list[withitem]'=_unset, body:'list[stmt]'=_unset, type_comment:'Any'=_unset) -> None:
        """start checking validation"""
...
class Match(ast.Match, stmt):

    def __init__(self, lineno: int=-1, col_offset: int=0, parent:Optional['AST']=None, *, end_lineno: Optional[int]=None, end_col_offset: Optional[int]=None) -> None:
        super().__init__(lineno, col_offset, parent, end_lineno=end_lineno, end_col_offset=end_col_offset)
        # all fields defaults to _unset_init
        self.subject = _unset_init
        self.cases = _unset_init

    def _postinit(self, subject:'expr'=_unset, cases:'list[match_case]'=_unset) -> None:
        """start checking validation"""
        if subject is _unset: raise ValueError('subject cannot be empty.')
        if cases is _unset: cases = []
        self.subject = subject
        self.cases = cases #type:ignore
...
class TryStar(ast.TryStar, stmt):
...
class NamedExpr(ast.NamedExpr, expr):
    ...
    def _postinit(self, target:'expr'=_unset, value:'expr'=_unset) -> None:
        """start checking validation"""
        if target is _unset: raise ValueError('target cannot be empty.')
        if value is _unset: raise ValueError('value cannot be empty.')
        self.target = target
...
class FormattedValue(ast.FormattedValue, expr):
    ...
    def _postinit(self, value:'expr'=_unset, conversion:'int'=_unset, format_spec:'expr | None'=_unset) -> None:
        """start checking validation"""
        if value is _unset: raise ValueError('value cannot be empty.')
        if conversion is _unset: raise ValueError('conversion cannot be empty.')
...
class Constant(ast.Constant, expr):
    ...
    def __init__(self, lineno: int=-1, col_offset: int=0, parent:Optional['AST']=None, *, end_lineno: Optional[int]=None, end_col_offset: Optional[int]=None) -> None:
        ...
        # all fields defaults to _unset_init
        self.value = _unset_init
        self.kind = _unset_init

    def _postinit(self, value:'Any'=_unset, kind:'str | None'=_unset) -> None:
        """start checking validation"""
        if value is _unset: raise ValueError('value cannot be empty.')
...
class arguments(ast.arguments, AST):
    ...
    def _postinit(self, posonlyargs:'list[arg]'=_unset, args:'list[arg]'=_unset, vararg:'arg | None'=_unset, kwonlyargs:'list[arg]'=_unset, kw_defaults:'list[expr | None]'=_unset, kwarg:'arg | None'=_unset, defaults:'list[expr]'=_unset) -> None:
        """start checking validation"""
        ...
        self.posonlyargs = posonlyargs #type:ignore
        self.args = args #type:ignore
        self.vararg = vararg
...
class arg(ast.arg, AST):
    ...
    def _postinit(self, arg:'str'=_unset, annotation:'expr | None'=_unset, type_comment:'Any'=_unset) -> None:
        """start checking validation"""
...
class match_case(ast.match_case, AST):

    def __init__(self, lineno: int=-1, col_offset: int=0, parent:Optional['AST']=None, *, end_lineno: Optional[int]=None, end_col_offset: Optional[int]=None) -> None:
        super().__init__(lineno, col_offset, parent, end_lineno=end_lineno, end_col_offset=end_col_offset)
        # all fields defaults to _unset_init
        self.pattern = _unset_init
        self.guard = _unset_init
        self.body = _unset_init

    def _postinit(self, pattern:'pattern'=_unset, guard:'expr | None'=_unset, body:'list[stmt]'=_unset) -> None:
        """start checking validation"""
        if pattern is _unset: raise ValueError('pattern cannot be empty.')
...
class MatchValue(ast.MatchValue, pattern):
...
class MatchSingleton(ast.MatchSingleton, pattern):
    ...
    def _postinit(self, value:'Literal[True, False, None]'=_unset) -> None:
        """start checking validation"""
        if value is _unset: raise ValueError('value cannot be empty.')
        self.value = value

class MatchSequence(ast.MatchSequence, pattern):

    def __init__(self, lineno: int=-1, col_offset: int=0, parent:Optional['AST']=None, *, end_lineno: Optional[int]=None, end_col_offset: Optional[int]=None) -> None:
        super().__init__(lineno, col_offset, parent, end_lineno=end_lineno, end_col_offset=end_col_offset)
        # all fields defaults to _unset_init
        self.patterns = _unset_init

    def _postinit(self, patterns:'list[pattern]'=_unset) -> None:
        """start checking validation"""
        if patterns is _unset: patterns = []
        self.patterns = patterns #type:ignore

class MatchMapping(ast.MatchMapping, pattern):
    ...
    def __init__(self, lineno: int=-1, col_offset: int=0, parent:Optional['AST']=None, *, end_lineno: Optional[int]=None, end_col_offset: Optional[int]=None) -> None:
        ...
        self.keys = _unset_init
        self.patterns = _unset_init
        self.rest = _unset_init

    def _postinit(self, keys:'list[expr]'=_unset, patterns:'list[pattern]'=_unset, rest:'str | None'=_unset) -> None:
        """start checking validation"""
        if keys is _unset: keys = []
        if patterns is _unset: patterns = []
...
class MatchClass(ast.MatchClass, pattern):

    def __init__(self, lineno: int=-1, col_offset: int=0, parent:Optional['AST']=None, *, end_lineno: Optional[int]=None, end_col_offset: Optional[int]=None) -> None:
        super().__init__(lineno, col_offset, parent, end_lineno=end_lineno, end_col_offset=end_col_offset)
        # all fields defaults to _unset_init
        self.cls = _unset_init
        self.patterns = _unset_init
        self.kwd_attrs = _unset_init
        self.kwd_patterns = _unset_init

    def _postinit(self, cls:'expr'=_unset, patterns:'list[pattern]'=_unset, kwd_attrs:'list[str]'=_unset, kwd_patterns:'list[pattern]'=_unset) -> None:
        """start checking validation"""
        if cls is _unset: raise ValueError('cls cannot be empty.')
        if patterns is _unset: patterns = []
        if kwd_attrs is _unset: kwd_attrs = []
        if kwd_patterns is _unset: kwd_patterns = []
        self.cls = cls
        self.patterns = patterns #type:ignore
        self.kwd_attrs = kwd_attrs #type:ignore
        self.kwd_patterns = kwd_patterns #type:ignore

class MatchStar(ast.MatchStar, pattern):
    ...
    def _postinit(self, name:'str | None'=_unset) -> None:
        """start checking validation"""
        if name is _unset: name = None
        self.name = name

class MatchAs(ast.MatchAs, pattern):
    ...
    def _postinit(self, pattern:'pattern | None'=_unset, name:'str | None'=_unset) -> None:
        """start checking validation"""
...
class MatchOr(ast.MatchOr, pattern):
...
class TypeIgnore(ast.TypeIgnore, type_ignore):

    def __init__(self, lineno: int=-1, col_offset: int=0, parent:Optional['AST']=None, *, end_lineno: Optional[int]=None, end_col_offset: Optional[int]=None) -> None:
        super().__init__(lineno, col_offset, parent, end_lineno=end_lineno, end_col_offset=end_col_offset)
        # all fields defaults to _unset_init
        self.lineno = _unset_init
        self.tag = _unset_init

    def _postinit(self, lineno:'Any'=_unset, tag:'str'=_unset) -> None:
        """start checking validation"""
        if lineno is _unset: raise ValueError('lineno cannot be empty.')
        if tag is _unset: raise ValueError('tag cannot be empty.')
        self.lineno = lineno
        self.tag = tag

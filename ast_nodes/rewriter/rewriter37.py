...
class NodesT(Protocol):
    ...
    Bytes: Type[nodes.Bytes]
    NameConstant: Type[nodes.NameConstant]
    Ellipsis: Type[nodes.Ellipsis]
    ...
    Del: Type[nodes.Del]
    AugLoad: Type[nodes.AugLoad]
    AugStore: Type[nodes.AugStore]
    Param: Type[nodes.Param]
    Slice: Type[nodes.Slice]
    ExtSlice: Type[nodes.ExtSlice]
    Index: Type[nodes.Index]
    And: Type[nodes.And]
    Or: Type[nodes.Or]
    Add: Type[nodes.Add]
    Sub: Type[nodes.Sub]
...
class Nodes(NodesT):
    """Class that aliases all concrete node classes as found in nodes37.py file."""
    Module = nodes.Module
    ...
    Bytes = nodes.Bytes
    NameConstant = nodes.NameConstant
    Ellipsis = nodes.Ellipsis
    ...
    Store = nodes.Store
    Del = nodes.Del
    AugLoad = nodes.AugLoad
    AugStore = nodes.AugStore
    Param = nodes.Param
    Slice = nodes.Slice
    ExtSlice = nodes.ExtSlice
    Index = nodes.Index
    And = nodes.And
    Or = nodes.Or
    Add = nodes.Add
...
class Rewriter(_BaseRewriter[_InputT, _OutputT, _ParentT]):
    ...
    if TYPE_CHECKING:
        ...
        @overload
        def visit(self, node:ast.Suite, parent:Optional[nodes.AST]) -> nodes.Suite:...
        @overload
        ...
        @overload
        def visit(self, node:ast.Num, parent:Optional[nodes.AST]) -> nodes.Num:...
        @overload
        def visit(self, node:ast.Str, parent:Optional[nodes.AST]) -> nodes.Str:...
        @overload
        ...
        @overload
        def visit(self, node:ast.Bytes, parent:Optional[nodes.AST]) -> nodes.Bytes:...
        @overload
        def visit(self, node:ast.NameConstant, parent:Optional[nodes.AST]) -> nodes.NameConstant:...
        @overload
        def visit(self, node:ast.Ellipsis, parent:Optional[nodes.AST]) -> nodes.Ellipsis:...
        @overload
        ...
        @overload
        def visit(self, node:ast.AugLoad, parent:Optional[nodes.AST]) -> nodes.AugLoad:...
        @overload
        def visit(self, node:ast.AugStore, parent:Optional[nodes.AST]) -> nodes.AugStore:...
        @overload
        def visit(self, node:ast.Param, parent:Optional[nodes.AST]) -> nodes.Param:...
        @overload
        def visit(self, node:ast.Slice, parent:Optional[nodes.AST]) -> nodes.Slice:...
        @overload
        def visit(self, node:ast.ExtSlice, parent:Optional[nodes.AST]) -> nodes.ExtSlice:...
        @overload
        def visit(self, node:ast.Index, parent:Optional[nodes.AST]) -> nodes.Index:...
        @overload
    ...
    def visit_Suite(self, node:ast.Suite, parent:nodes.AST) -> nodes.Suite:
        newnode = self.nodes.Suite(
            parent = parent,
            lineno = getattr(node, 'lineno', -1),
            col_offset = getattr(node, 'col_offset', -1),
            end_lineno = getattr(node, 'end_lineno', -1),
    ...
    def visit_Num(self, node:ast.Num, parent:nodes.AST) -> nodes.Num:
        newnode = self.nodes.Num(
            parent = parent,
            lineno = getattr(node, 'lineno', -1),
            col_offset = getattr(node, 'col_offset', -1),
            end_lineno = getattr(node, 'end_lineno', -1),
    ...
    def visit_Str(self, node:ast.Str, parent:nodes.AST) -> nodes.Str:
        newnode = self.nodes.Str(
            parent = parent,
            lineno = getattr(node, 'lineno', -1),
            col_offset = getattr(node, 'col_offset', -1),
            end_lineno = getattr(node, 'end_lineno', -1),
    ...
    def visit_Bytes(self, node:ast.Bytes, parent:nodes.AST) -> nodes.Bytes:
        newnode = self.nodes.Bytes(
            parent = parent,
            lineno = getattr(node, 'lineno', -1),
            col_offset = getattr(node, 'col_offset', -1),
            end_lineno = getattr(node, 'end_lineno', -1),
    ...
    def visit_NameConstant(self, node:ast.NameConstant, parent:nodes.AST) -> nodes.NameConstant:
        newnode = self.nodes.NameConstant(
            parent = parent,
            lineno = getattr(node, 'lineno', -1),
            col_offset = getattr(node, 'col_offset', -1),
            end_lineno = getattr(node, 'end_lineno', -1),
    ...
    def visit_Ellipsis(self, node:ast.Ellipsis, parent:nodes.AST) -> nodes.Ellipsis:
        newnode = self.nodes.Ellipsis(
            parent = parent,
            lineno = getattr(node, 'lineno', -1),
            col_offset = getattr(node, 'col_offset', -1),
            end_lineno = getattr(node, 'end_lineno', -1),
    ...
    def visit_AugLoad(self, node:ast.AugLoad, parent:nodes.AST) -> nodes.AugLoad:
        newnode = self.nodes.AugLoad(
            parent = parent,
            lineno = getattr(node, 'lineno', -1),
            col_offset = getattr(node, 'col_offset', -1),
            end_lineno = getattr(node, 'end_lineno', -1),
    ...
    def visit_AugStore(self, node:ast.AugStore, parent:nodes.AST) -> nodes.AugStore:
        newnode = self.nodes.AugStore(
            parent = parent,
            lineno = getattr(node, 'lineno', -1),
            col_offset = getattr(node, 'col_offset', -1),
            end_lineno = getattr(node, 'end_lineno', -1),
    ...
    def visit_Param(self, node:ast.Param, parent:nodes.AST) -> nodes.Param:
        newnode = self.nodes.Param(
            parent = parent,
            lineno = getattr(node, 'lineno', -1),
            col_offset = getattr(node, 'col_offset', -1),
            end_lineno = getattr(node, 'end_lineno', -1),
    ...
    def visit_ExtSlice(self, node:ast.ExtSlice, parent:nodes.AST) -> nodes.ExtSlice:
        newnode = self.nodes.ExtSlice(
            parent = parent,
            lineno = getattr(node, 'lineno', -1),
            col_offset = getattr(node, 'col_offset', -1),
            end_lineno = getattr(node, 'end_lineno', -1),
        ...
        dims = [self.visit(n, newnode) for n in node.dims]
    ...
    def visit_Index(self, node:ast.Index, parent:nodes.AST) -> nodes.Index:
        newnode = self.nodes.Index(
            parent = parent,
            lineno = getattr(node, 'lineno', -1),
            col_offset = getattr(node, 'col_offset', -1),
            end_lineno = getattr(node, 'end_lineno', -1),
